...
export function Calendar({
  ...
  // Custom formatter for Jalali month and year
  function formatCaption(date: Date) {
    return (
      <div className="flex flex-col items-center justify-center">
        <span>{format(date, "MMMM", { locale: faIR })}</span>
        <span className="text-xs text-muted-foreground">{format(date, "yyyy", { locale: faIR })}</span>
      </div>
    )
  }
